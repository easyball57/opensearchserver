...
public class PhantomJSParser extends WebDriverParserAbstract {

	public PhantomJSParser() {
		super(HtmlParserEnum.PhantomJS);
	}

	@Override
	protected BrowserDriver<?> getWebDriver() throws InstantiationException, IllegalAccessException {
		return BrowserDriverEnum.PHANTOM_JS.getNewInstance();
	}
