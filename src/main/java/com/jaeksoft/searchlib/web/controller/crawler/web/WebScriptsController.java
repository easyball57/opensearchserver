...
public class WebScriptsController extends
	...
	public WebScriptsController() throws SearchLibException {
		super();
	}

	@Override
	protected AbstractPatternNameValueManager<WebScriptItem> getManager(
			Client client) throws SearchLibException {
		return client.getWebScriptManager();
	}

	@Override
	protected WebScriptItem newItem() {
		return new WebScriptItem();
	}
